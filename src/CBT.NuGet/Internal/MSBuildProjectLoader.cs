...
namespace CBT.NuGet.Internal
{
    ...
    internal sealed class MSBuildProjectLoader
    {
        ...
        {
            // https://github.com/Microsoft/msbuild/blob/master/src/Shared/Traits.cs#L37
            // https://github.com/Microsoft/msbuild/blob/master/src/Build/Utilities/EngineFileUtilities.cs#L22
            // Does lazy expansion on itemgroups with regex matching MsBuildSkipEagerWildCardEvaluationRegexes.  ; delimited list.
            // lazy expansion needed for cases where itemgroup is a property that is an autogenerated nuget property that doesn't exist yet because restore hasn't been done.
            string currentEnvValue = Environment.GetEnvironmentVariable("MsBuildSkipEagerWildCardEvaluationRegexes");
            ...
            {
                Environment.SetEnvironmentVariable("MsBuildSkipEagerWildCardEvaluationRegexes", currentEnvValue);
            }
